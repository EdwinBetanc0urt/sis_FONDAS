					...
					<div class="form-horizontal">
						<div class="form-group ui-front">
							...
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
								...
								<select id='cmbMunicipio' name='cmbMunicipio' class="dinamico form-control select2" data-toggle="tooltip" data-placement="right" title="Estado al cual pertenece el municipio" size="1" style="width: 100%;">
									<option value="">Selecciona Uno...</option>
								</select>
