	...
	<link rel="stylesheet" href="public/bootstrap-datetimepicker_Eonasdan/css/bootstrap-datetimepicker.css">
	...
	<?php
		...
		if ( isset( $_GET['getOpcion'] ) ) { 
			...
			<script type='application/x-javascript'>
				...
				//imprime codigo JavaScript y abre la ventana modal con id VentanaModal
				$(document).ready(function(){ //para version 0.97.8 de materialize.js
					$("#VentanaModal").modal('show'); //para boostrap v3.3.7
					//$( "#VentanaModal" ).modal('open'); //para version 0.97.8 de materialize.js
					//$( "#VentanaModal" ).openModal(); //para version 0.97.3 de materialize.js
				});
			</script>
			<?php 
		}
	...
	<script type="text/javascript">
		...
		//minetras este haciendo escribiendo o cambiando algo de la pagina
		//reseteara el tiempo de inactividad
