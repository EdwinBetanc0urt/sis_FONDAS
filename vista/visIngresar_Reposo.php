		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h2 class="modal-title">Ingreso de Reposo</h2>
				</div>
					...
					<div class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<label for="cmbMotivo_Reposo">* Motivo de Reposo</label>
								<select id='cmbMotivo_Reposo' name='cmbMotivo_Reposo' class="dinamico form-control select2" data-toggle="tooltip" required  data-placement="right" title="Campo obligatorio" size="1" style="width: 100%;">
