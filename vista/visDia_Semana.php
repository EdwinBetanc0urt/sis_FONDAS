...
<div class="panel-heading">
	<h3 class="panel-title"> 	
		...
		Numeración según el estándar ISO-8601, de los días de la semana
	</h3>
</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h2 class="modal-title"> Días de la Semana </h2>
				</div>
						...
						<div class="form-group ui-front">
							...
							<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
								<input name="numId" id="numId" type="hidden" class="form-control" readonly onkeypress="return false" data-toggle="tooltip" data-placement="right" title="Código asignado automáticamente" value="<?php 
									if(isset($_GET["getId"])) 
										echo $_GET["getId"]; ?>" />
								<label for="numDia">* Nro Día</label>
								<input id="numDia" class="valida_num_entero form-control" maxlength="45" name="numDia" type="number" min="1" max="7" required value="<?php
									if(isset($_GET['getDia']))
										echo $_GET['getDia'];
