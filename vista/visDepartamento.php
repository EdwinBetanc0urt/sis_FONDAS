					...
					<div class="form-horizontal">
						<div class="form-group ui-front">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								...
								<textarea cols="5" id="ctxDescripcion" class="valida_alfabetico form-control" required maxlength="150" name="ctxDescripcion" type="text" placeholder="Ingrese el departamento" data-toggle="tooltip" data-placement="right" title="Campo Obligatorio" ><?php
									if( isset( $_GET['getDescripcion'] ) )
										echo $_GET['getDescripcion'];
								?></textarea>
							</div>

							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="divEncargado">
								<br>
								<label for="cmbEncargado">* Encargado del Departamento</label>
								<select id='cmbEncargado' name='cmbEncargado' class="dinamico form-control select2" data-toggle="tooltip" required  data-placement="right" title="Campo obligatorio" size="1" style="width: 100%;">
									<option value="">Selecciona Uno...</option>
								</select>
								<input id="hidEncargado" type="hidden" value="<?php
									if( isset( $_GET['getEncargado'] ) )
										echo $_GET['getEncargado']; ?>" />
							</div>
