...
if(isset($_SESSION["sesion"]) AND $_SESSION["sesion"] == "sistema") {
	$vsVista = "Revisar_Reposos";
	$liVista = "40";
?>

<div class="panel-heading">
	<h3 class="panel-title">
		Revisar Solicitudes de Reposos
	</h3>
</div>
...
<div class="panel-body">
	<ul class="nav nav-tabs" id="myTab">
		...
		<li>
			<a data-toggle="tab" href="#pestRevisado">Revisada en Espera</a>
		</li>
		<li>
	...
	<div class="tab-content">	
		...
		<div id="pestRevisado" class="tab-pane fade">
			<form action="" name="formLista<?= $vsVista; ?>Revisados" id="formLista<?= $vsVista; ?>Revisados" role="form">
				<div class="row">
					<div class="form-group" >
						<div class="col-xs-10">
							<div class="input-group">
								...
								<input type="search" id="ctxBusqueda" name="ctxBusqueda" 
								oninput="fjMostrarLista('<?= $vsVista; ?>', '', '', '<?= $vsVista; ?>Revisados', 'ListaViewRevisado');"
								onkeyup="fjMostrarLista('<?= $vsVista; ?>', '', '', '<?= $vsVista; ?>Revisados', 'ListaViewRevisado');" 
								class="valida_buscar form-control" 
								placeholder="Filtro de Busqueda" data-toggle="tooltip" data-placement="top" title="Terminos para buscar coincidencias en los registros" />
							</div>	
						</div>
						...
						<div class="col-xs-2">
							<div class="input-group">
								...
								<input type="number" id="numItems" name="numItems" maxlength="4" 
								value="10" onkeyup="fjMostrarLista('<?= $vsVista; ?>', '', '', '<?= $vsVista; ?>Revisados', 'ListaViewRevisado');" required
								class="valida_num_entero form-control" placeholder="Items" data-toggle="tooltip" data-placement="top" title="Cantidad de items a mostrar en el listado" />
							</div>	
						</div>
					</div>
