...
function enviar(pvValor) {
	...
	let vsTipo_Ausencia= document.getElementById("cmbTipo_Ausencia");
...
function fjSeleccionarRegistro(pvDOM) {
    ...
    $("#form" + lsVista + " #hidTipo_Ausencia").val(arrFilas[4].trim());
    fjComboGeneral("Tipo_Ausencia");
	$("#form" + lsVista + " #ctxCantidad_Dias").val(arrFilas[6].trim());
