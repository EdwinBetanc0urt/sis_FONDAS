...
function enviar( pvValor ) {
	...
	var viNumero = document.getElementById("numDia");
...
function fjSeleccionarRegistro( pvDOM ) {
    ...
    $( "#form" + lsVista + " #numDia" ).val(  parseInt( arrFilas[3].trim() ) );
    $( "#form" + lsVista + " #ctxNombre" ).val( arrFilas[4].trim() );
