...
function fjSeleccionarRegistro(pvDOM) {
    ...
    $("#divEncargado").css("display", "");
    $("#form" + lsVista + " #hidEncargado").val(arrFilas[5].trim());
    fjComboGeneral("trabajador", arrFilas[2].trim(), "Encargado", "ListaComboTrabajadorDepartamento");
