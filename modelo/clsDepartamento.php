...
class Departamento extends clsConexion {
	...
	function __construct() {
		...
		$this->atrTabla = "tdepartamento";
		$this->atrId = "iddepartamento";
	...
	function Modificar() {
		$sql = "
			...
			SET 
				...
				idtrabajador = '{$this->atrFormulario["cmbEncargado"]}' 
			WHERE 
	...
	function fmListarIndex($psBuscar) {		
		$sql = "
			...
			WHERE
				...
				nombre LIKE '%{$psBuscar}%' OR 
				descripcion LIKE '%{$psBuscar}%') "; //selecciona todo de la tabla
