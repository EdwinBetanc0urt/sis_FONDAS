...
function UltimoCodigoTipo_Usuario() {
	$objTipo_Usuario = new Tipo_Usuario(); //instancia la clase
	$arrCodigo = $objTipo_Usuario->UltimoCodigo(); //obtiene el arreglo con el codigo
...
function cambiar() {
	...
	$objTipo_Usuario->setFormulario($_POST);
	//var_dump($objTipo_Usuario->Modificar());/*
	if ($objTipo_Usuario->Modificar()) //si el fmInsertar es verdadero, realiza las sentencias
...
function borrar() {
	...
	$objTipo_Usuario = new Tipo_Usuario();
	$objTipo_Usuario->setFormulario($_POST);
	if ($objTipo_Usuario->Eliminar()) //si el fmInsertar es verdadero, realiza las sentencias
