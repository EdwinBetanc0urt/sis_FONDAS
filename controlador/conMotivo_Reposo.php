...
function UltimoCodigoMotivo_Reposo() {
	$objMotivo_Reposo = new Motivo_Reposo(); //instancia la clase
	$arrCodigo = $objMotivo_Reposo->UltimoCodigo(); //obtiene el arreglo con el codigo
...
function cambiar() {
	global $gsClase;
	$objMotivo_Reposo = new Motivo_Reposo();
	$objMotivo_Reposo->setFormulario($_POST);
	//var_dump($objMotivo_Reposo->Modificar());/*
	if ($objMotivo_Reposo->Modificar()) //si el fmInsertar es verdadero, realiza las sentencias
...
function borrar() {
	...
	$objMotivo_Reposo = new Motivo_Reposo();
	$objMotivo_Reposo->setFormulario($_POST);
	if ($objMotivo_Reposo->Eliminar()) //si el fmInsertar es verdadero, realiza las sentencias
					...
					<thead>
						<tr class='info'>
                            ...
                            <th datos_orden_metodo="asc" datos_orden="<?= $objeto->atrCantidad_Dias; ?>" onclick='fjMostrarLista("<?= $gsClase; ?>", "<?= $vpPaginaActual; ?>", "<?= $objeto->atrCantidad_Dias; ?>")' >
								Duracion en Dias <span class='glyphicon glyphicon-sort'></span>
							</th>
