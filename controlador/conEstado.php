...
function UltimoCodigoEstado() {
	$objEstado = new Estado(); //instancia la clase
...
function ListaEstado() {
	...
	$objeto = new Estado; //instancia la clase
	...
	if ($rstRecordSet) {
		...
		?>
			<div class='table-responsive'>
				<br><br>
				<table border='1' valign='center' class='table table-striped text-center table-hover' id="tabLista<?= $gsClase; ?>">
					<thead>
						<tr class='info'>
