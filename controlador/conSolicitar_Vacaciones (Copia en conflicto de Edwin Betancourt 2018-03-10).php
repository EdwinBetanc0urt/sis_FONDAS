...
switch( $_POST['operacion'] ) {
	...
	case 'Antiguedad':
		$resultado = $objCalcula->getAntiguedad();
		echo $resultado;
		break;
	case 'Dias':
		$resultado = $objCalcula->getDiasVacaciones( "", );
		echo $resultado;
		break;
	case 'FechaFin':
		$resultado = $objCalcula->getFechaFinal( $_POST["fecha_inicio"], $_POST["dias"]);
		echo $resultado;
		break;
...
function listarPeriodos() {
	...
	$arrPeriodos = getPeriodosAntiguedad( $_SESSION["fecha_ingreso"] );
			...
			<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				...
				<div class="input-group" id="periodo<?= $liCont; ?>">
					...
					<span class="input-group-addon">
						<input type="radio" aria-label="..." name="radPeriodo" value="<?= $value; ?>" />
					</span>
