...
function UltimoCodigoDepartamento() {
	$objDepartamento = new Departamento(); //instancia la clase
	$arrCodigo = $objDepartamento->UltimoCodigo(); //obtiene el arreglo con el codigo
...
function registrar() {
	...
	if ($arreglo) {
		...
		header("Location: ../?form={$gsClase}" .
			...
			"&getDescripcion=" . $arreglo["descripcion"] .
...
function cambiar() {
	...
	$objDepartamento->setFormulario($_POST);
	//var_dump($objDepartamento->Modificar());/*
	if ($objDepartamento->Modificar()) //si el fmInsertar es verdadero, realiza las sentencias
...
function borrar() {
	...
	$objDepartamento = new Departamento();
	$objDepartamento->setFormulario($_POST);
	if ($objDepartamento->Eliminar()) //si el fmInsertar es verdadero, realiza las sentencias
...
function ListaDepartamento() {
	...
	$objeto = new Departamento; //instancia la clase
