...
function UltimoCodigoAusencia() {
	$objAusencia = new Ausencia(); //instancia la clase
	$arrCodigo = $objAusencia->UltimoCodigo(); //obtiene el arreglo con el codigo
...
function lista() {
	global $gsClase;
	$objeto = new Ausencia; //instancia la clase
