...
function UltimoCodigoPregunta() {
	$objPregunta = new Pregunta(); //instancia la clase
	$arrCodigo = $objPregunta->UltimoCodigo(); //obtiene el arreglo con el codigo
...
function cambiar() {
	...
	$objPregunta->setFormulario($_POST);
	//var_dump( $objPregunta->Modificar() );/*
	if ( $objPregunta->Modificar() ) //si el fmInsertar es verdadero, realiza las sentencias
...
function borrar() {
	...
	$objPregunta = new Pregunta();
	$objPregunta->setFormulario($_POST);
	if ( $objPregunta->Eliminar() ) //si el fmInsertar es verdadero, realiza las sentencias
...
function ListaPregunta() {
	...
	$objeto = new Pregunta; //instancia la clase
