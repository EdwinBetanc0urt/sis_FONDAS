...
function UltimoCodigoDia_Semana() {
	$objDia_Semana = new Dia_Semana(); //instancia la clase
	$arrCodigo = $objDia_Semana->UltimoCodigo(); //obtiene el arreglo con el codigo
...
function cambiar() {
	global $gsClase;
	$objDia_Semana = new Dia_Semana();
	$objDia_Semana->setFormulario($_POST);
	//var_dump($objDia_Semana->Modificar());/*
	if ($objDia_Semana->Modificar()) //si el fmInsertar es verdadero, realiza las sentencias
...
function borrar() {
	...
	$objDia_Semana = new Dia_Semana();
	$objDia_Semana->setFormulario($_POST);
	if ($objDia_Semana->Eliminar()) //si el fmInsertar es verdadero, realiza las sentencias
